...
export default function HomePage() {
  ...
  return (
    <div className="text-charcoal bg-white">
      ...
      {/* ── 7. THE TABLE (Journal) ──────────────────────────────────────────── */}
      <section className="bg-charcoal text-charcoal py-24 md:py-36">
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="mb-16 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              <SectionLabel>
                <span className="text-warmth">Stories &amp; Thinking</span>
              </SectionLabel>
            ...
            <Link
              href="/the-table"
              className="group text-warmth inline-flex items-center gap-2 text-sm font-medium transition-colors"
            >
              All stories
              <span className="inline-block transition-transform group-hover:translate-x-1">
                →
            ...
            <div className="grid items-center gap-12 md:grid-cols-2">
              <div>
                ...
                <div className="flex flex-wrap gap-4">
                  <Link
                    href="/events"
                    className="bg-warmth hover:bg-earth inline-flex items-center gap-2 px-7 py-3.5 text-sm font-medium tracking-wide transition-colors"
                  >
                    See all events
                  </Link>
                  <Link
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            */}
            <div className="mx-auto flex max-w-md flex-col gap-3 sm:flex-row">
              ...
              <button
                type="submit"
                className="bg-warmth hover:bg-earth px-7 py-3.5 text-sm font-medium whitespace-nowrap transition-colors"
              >
                Join the table
              </button>
            </div>
